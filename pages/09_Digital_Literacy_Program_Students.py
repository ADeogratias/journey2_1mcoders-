...
st.set_page_config(page_title="Digital Literacy Program Students – Metrics", layout="wide")

# Sidebar theme toggle
mode = st.sidebar.radio("Appearance", ["Light", "Dark"], index=1, horizontal=True)
apply_theme(mode)
render_sidebar_nav("dl_students")

prog_name = "Digital Literacy Program Students"
