...
st.set_page_config(page_title="Udacity - One Million Rwandan Coders Program – Metrics", layout="wide")

# Sidebar theme toggle
mode = st.sidebar.radio("Appearance", ["Light", "Dark"], index=1, horizontal=True)
apply_theme(mode)
render_sidebar_nav("udacity")

prog_name = "Udacity - One Million Rwandan Coders Program"
