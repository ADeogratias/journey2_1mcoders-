...
st.set_page_config(page_title="Digital Literacy Program Teachers – Metrics", layout="wide")

# Sidebar theme toggle
mode = st.sidebar.radio("Appearance", ["Light", "Dark"], index=0, horizontal=True)
apply_theme(mode)
render_sidebar_nav("dl_teachers")

prog_name = "Digital Literacy Program Teachers"
