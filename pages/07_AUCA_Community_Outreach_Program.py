...
st.set_page_config(page_title="AUCA - Community Outreach Program – Metrics", layout="wide")

# Sidebar theme toggle
mode = st.sidebar.radio("Appearance", ["Light", "Dark"], index=1, horizontal=True)
apply_theme(mode)
render_sidebar_nav("auca_outreach")

prog_name = "AUCA - Community Outreach Program"
