...
st.set_page_config(page_title="RISA - Training of Public IT Professionals (Up-skilled and Re-skilled) – Metrics", layout="wide")

# Sidebar theme toggle
mode = st.sidebar.radio("Appearance", ["Light", "Dark"], index=0, horizontal=True)
apply_theme(mode)
render_sidebar_nav("risa_it")

prog_name = "RISA - Training of Public IT Professionals (Up-skilled and Re-skilled)"
