...
st.set_page_config(page_title="African Girls Can Code Initiative – Metrics", layout="wide")

# Sidebar theme toggle
mode = st.sidebar.radio("Appearance", ["Light", "Dark"], index=0, horizontal=True)
apply_theme(mode)
render_sidebar_nav("agcci")

prog_name = "African Girls Can Code Initiative"
